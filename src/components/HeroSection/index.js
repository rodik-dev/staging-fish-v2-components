...
import InlineMarkdown from '@stackbit/components/components/InlineMarkdown';
...
function heroBody(props) {
    ...
    return (
        ...
        >
            ...
            {props.title && (
                <h2 className="text-4xl tracking-tight sm:text-5xl mb-6" data-sb-field-path=".titlexx">
